...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "6899668612:AAEYfCLysj4Y612TY-MTGMdGpgSR6xIRwOk"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'EMILYCHATGPTBOT'
username = 'EMILYCHATGPTBOT'
